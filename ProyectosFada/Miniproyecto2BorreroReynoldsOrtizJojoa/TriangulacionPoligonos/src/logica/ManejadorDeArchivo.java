...
//-----------------------------------------Leyendo El Tablero-------------------------------------------------
                ...
                vectorX = new int [fila];
                vectorY = new int [fila];
...
//                System.out.println("inicializo la matrizFinal");
                ...
                for(int i=0; i < fila*columna; i++)
                {
                    if(i%2 == 0)
                    {
                        int localTmp = Integer.parseInt((String)(matrizVector.elementAt(i)));
                        vectorX[contador] = localTmp;
                        System.out.println("VectorX: "+localTmp);
                        contador++;
                    ...
                    {
                        int localTmp = Integer.parseInt((String)(matrizVector.elementAt(i)));
                        vectorY[counter] = localTmp;
                        System.out.println("VectorY: "+localTmp);
                        counter++;
                    }
                }
...
//	leerArchivoEntrada("C:/Users/sergio/Desktop/FADA2012/Akari/Akari/entrada/TableroEjemplo.txt");
	...
	*/
	public void crearMatrizDesdeArchivo(){
         ...
         */
        public static String toString(double [][] entrada){
            String salida="";
