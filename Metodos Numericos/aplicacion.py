...
# -*- coding: utf-8 -*-
#
# name:        PyRaices.py (Python 3.x).
# description: Encunentra raices de funciones a través de algoritmos de métodos númericos
# purpose:     Relacionar lo aprendido en clase con la ejecución de dichos algoritmos
#              
# author:      Sergio Ortiz Paz
#
#------------------------------------------------------------

'''PyRaices: Implementa algoritmos de bisección, Newton-Raphson y secante '''
   
__author__ = 'Sergio Ortiz Paz'
__title__= 'PyRaices'
__date__ = 'Feb-26-2017'
__version__ = '0.0.1'
...
class PyRemoto():
    ...
    def __init__(self):                      
        ...
        self.raiz.title(__author__ + " " + __version__)  # Título
        ...
        try:
          ...
          print("Sistema Operativo no Unix")
          info1 = "Sistema no Unix"
          info2 = "Default"
          info3 = "Machine-Default"
