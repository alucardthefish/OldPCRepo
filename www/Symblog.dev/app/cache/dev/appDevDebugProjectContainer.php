...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => 'sergiop', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EM51052c7f1cf98_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EM51052c7f1cf98_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/wamp/www/Symblog.dev/app/cache/dev/jms_diextra/doctrine/EntityManager.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_46c7244c46639e214cc0147c3d3bdb8e');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_46c7244c46639e214cc0147c3d3bdb8e');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_46c7244c46639e214cc0147c3d3bdb8e');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EM51052c7f1cf98_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '5cf841e9a8e6f293367655fad566b935');
    }
    ...
    protected function getSwiftmailer_Transport_RealService()
    {
        ...
        $instance->setUsername('sergiop18');
        $instance->setPassword('checho6');
     ...
     *
     * @return EM51052c7f1cf98_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'sergiop18',
            'mailer_password' => 'checho6',
            'locale' => 'en',
            'secret' => '5cf841e9a8e6f293367655fad566b935',
            'database_path' => NULL,
            ...
            'kernel.secret' => '5cf841e9a8e6f293367655fad566b935',
            ...
            'swiftmailer.transport.smtp.username' => 'sergiop18',
            'swiftmailer.transport.smtp.password' => 'checho6',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/wamp/www/Symblog.dev/app/cache/dev/jms_diextra/doctrine/EntityManager.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EM51052c7f1cf98_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
