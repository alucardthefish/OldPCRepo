...
public class ServidorHilo extends JFrame
{
	...
	private void esperarConexion(Thread cliente) throws IOException			//trato de que puedan entrar varios clienteshilos
	{
	...
	{
		ServidorHilo server = new ServidorHilo();
